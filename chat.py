...
# split the text to chunks of size 1000
...
def answer(prompt: str, persist_directory: str = config.PERSIST_DIR) -> str:
    # Your chatbot logic using Langchain to generate the answer based on the user's input.
    # This function should return the response generated by your chatbot.
    # Make sure you have imported any required modules or libraries for your chatbot logic.
